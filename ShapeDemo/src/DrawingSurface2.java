...
/*
 * This version has the circle in the purple box and a rectangle at the bottom. 
 * left click and drag the circle
 * right click and drag the thin purple rectangle
 * if the circle comes in contact with the rectangle, it will return to the original position
 * 
 */
public class DrawingSurface2 extends PApplet{
	...
	private boolean boundDragged;


	public DrawingSurface2() {
		c1 = new Circle(240, 200, 50);
	...
	public void draw() {
		...
		if(circle.getCoordinate(1)>=secondBound.getCoordinate(1)-25 && circle.getCoordinate(1)<= (secondBound.getCoordinate(1)+75)) { //if the circle comes into contact w line, will go back to original position 
	...
	public void mouseDragged() {
		...
		//right click is for rectangle
			...
			if(boundDragged == true) {
				r3.move(mouseX, mouseY);
			}
